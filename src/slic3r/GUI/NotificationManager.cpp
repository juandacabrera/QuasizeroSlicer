...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = m_is_dark ? ImVec4(0.54f, 0.38f, 0.27f, 1) : ImVec4(0.54f, 0.38f, 0.27f, 1);
	m_HyperTextColorHover = m_is_dark ? ImVec4(0.65f, 0.51f, 0.37f, 1) : ImVec4(0.43f, 0.30f, 0.21f, 1); //#A5825F / #813C0A;
