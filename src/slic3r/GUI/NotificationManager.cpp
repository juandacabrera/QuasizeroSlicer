...
void NotificationManager::PopNotification::use_bbl_theme()
{
 ...
 //   OldStyle.Colors[ImGuiCol_Text]     = m_TextColor;
	...
	m_HyperTextColor = m_is_dark ? ImVec4(0.23f, 0.22f, 0.21f, 1) : ImVec4(0.23f, 0.22f, 0.21f, 1);
	m_HyperTextColorHover = m_is_dark ? ImVec4(0.42f, 0.41f, 0.40f, 1) : ImVec4(0.16f, 0.16f, 0.15f, 1); //#55524E / #813C0A;
