    ...
    , m_mapping_tutorial_popup(AmsTutorialPopup(this))
{
    ...
    m_link_edit_nozzle->SetForegroundColour("#8A6244");
    ...
    m_statictext_finish->SetForegroundColour(wxColour(150, 70, 12));
...
void PrintOptionItem::doRender(wxDC& dc)
{
    ...
    for (auto it = m_ops.begin(); it != m_ops.end(); ++it)
    {
        ...
        {
            const wxColour& clr = m_enable ? StateColor::darkModeColorFor("#8A6244") : StateColor::darkModeColorFor(wxColour(144, 144, 144));
            dc.SetPen(wxPen(clr));
