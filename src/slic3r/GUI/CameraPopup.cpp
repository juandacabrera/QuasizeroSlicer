...
const wxColour TEXT_COL = wxColour(54, 48, 44);
   ...
   : PopupWindow(parent, wxBORDER_NONE | wxPU_CONTAINS_CONTROLS)
{
    ...
    m_custom_camera_input_confirm->SetBackgroundColor(wxColour(166, 97, 48));
    m_custom_camera_input_confirm->SetBorderColor(wxColour(166, 97, 48));
...
void CameraPopup::set_custom_cam_button_state(bool state)
{
    ...
    auto stateColour = state ? wxColour(170, 0, 0) : wxColour(166, 97, 48);
