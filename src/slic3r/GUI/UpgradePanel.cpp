...
static const wxColour TEXT_NORMAL_CLR = wxColour(58, 56, 53);
...
wxPanel *MachineInfoPanel::create_caption_panel(wxWindow *parent)
{
    ...
    m_caption_text->SetForegroundColour("#30302F");
    ...
    : wxPanel(parent,id,pos,size,style)
{
     ...
     m_staticText_ams->SetForegroundColour("#30302F");
     ...
     m_staticText_ams_sn->SetForegroundColour("#30302F");
     ...
     m_staticText_ams_sn_val->SetForegroundColour("#30302F");
     ...
     m_staticText_ams_ver->SetForegroundColour("#30302F");
     ...
     m_staticText_ams_ver_val->SetForegroundColour("#30302F");
     ...
     : wxPanel(parent, id, pos, size, style)
 {
     ...
     m_staticText_ext->SetForegroundColour("#30302F");
     ...
     m_staticText_ext_val->SetForegroundColour("#30302F");
     ...
     m_staticText_ext_sn->SetForegroundColour("#30302F");
     ...
     m_staticText_ext_sn_val->SetForegroundColour("#30302F");
     ...
     m_staticText_ext_ver->SetForegroundColour("#30302F");
     ...
     m_staticText_ext_ver_val->SetForegroundColour("#30302F");
