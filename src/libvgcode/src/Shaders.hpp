...
"  return mix(mix(mix(qz_hash(i), qz_hash(i + vec3(1,0,0)), f.x),\n"
"                 mix(qz_hash(i + vec3(0,1,0)), qz_hash(i + vec3(1,1,0)), f.x), f.y),\n"
"             mix(mix(qz_hash(i + vec3(0,0,1)), qz_hash(i + vec3(1,0,1)), f.x),\n"
"                 mix(qz_hash(i + vec3(0,1,1)), qz_hash(i + vec3(1,1,1)), f.x), f.y), f.z);\n"
"}\n"
