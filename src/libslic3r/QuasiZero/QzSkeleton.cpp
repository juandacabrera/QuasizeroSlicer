// Quasizero Slicer - QzSkeleton / QzTubeMesher implementation. GNU AGPLv3 inside the public
// Quasizero Slicer LITE; identical copy in the Quasizero simulation engine (dual-licensed).
