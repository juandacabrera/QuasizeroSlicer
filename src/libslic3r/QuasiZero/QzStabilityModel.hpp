...
// Include guard rather than `#pragma once`: the Quasizero simulation engine carries an
// identical copy of this header and a PRO build of the slicer reaches both copies through
// different paths (the build checks that they match).
#ifndef QZ_STABILITY_MODEL_HPP
#define QZ_STABILITY_MODEL_HPP
