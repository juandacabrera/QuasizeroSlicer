...
PRINT_CONFIG_CLASS_DEFINE(
    ...
    // Quasizero: paste stability parameters (see QuasiZero/QzStabilityModel)
    ((ConfigOptionFloats,              qzmini_paste_yield_stress))
    ((ConfigOptionFloats,              qzmini_paste_structuration_rate))
    ((ConfigOptionFloats,              qzmini_paste_elastic_modulus))
    ((ConfigOptionFloats,              qzmini_paste_stiffening_rate))
    ((ConfigOptionFloats,              qzmini_paste_poisson))
    ((ConfigOptionFloats,              qzmini_paste_yield_factor))
    ...
    // Quasizero QZmini (namespaced; see QuasiZero/ module)
    ((ConfigOptionBool,                qzmini_enable))
    ((ConfigOptionFloat,               qzmini_barrel_inner_diameter))
    ((ConfigOptionFloat,               qzmini_nominal_syringe_capacity_ml))
    ...
    ((ConfigOptionFloat,               qzmini_ssa_extra_prime_e))
    ((ConfigOptionFloat,               qzmini_ssa_depart_speed))
    ((ConfigOptionBool,                qzmini_refill_enable))
    ((ConfigOptionFloat,               qzmini_refill_threshold_ml))
    ((ConfigOptionFloat,               qzmini_park_x))
    ((ConfigOptionFloat,               qzmini_park_y))
    ((ConfigOptionFloat,               qzmini_park_z_lift))
    ((ConfigOptionBool,                qzmini_plunger_reset_enable))
    ((ConfigOptionFloat,               qzmini_plunger_reset_feedrate))
    ((ConfigOptionBool,                qzmini_prime_after_refill_enable))
    ((ConfigOptionFloat,               qzmini_prime_after_refill_ml))
    ((ConfigOptionFloat,               qzmini_prime_feedrate))
    ((ConfigOptionString,              qzmini_pause_strategy))
    ((ConfigOptionString,              qzmini_pause_custom_gcode))
    ((ConfigOptionBool,                qzmini_refill_show_in_preview))
    ((ConfigOptionBool,                qzmini_stability_enable))
    ((ConfigOptionFloat,               qzmini_stability_safety_factor))
    ((ConfigOptionBool,                qzmini_stability_base_confinement))
    //BBS
