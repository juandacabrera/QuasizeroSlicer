...
public:
    ...
    static const ColorRGB ORCA()		{ return {138.0f / 255.0f, 98.0f / 255.0f, 68.0f / 255.0f}; } // Quasizero warm brown
...
public:
    ...
    static const ColorRGBA ORCA()        { return {138.0f / 255.0f, 98.0f / 255.0f, 68.0f / 255.0f, 1.0f}; } // Quasizero warm brown
