...
public:
    ...
    static const ColorRGB ORCA()		{ return {58.0f / 255.0f, 56.0f / 255.0f, 53.0f / 255.0f}; } // Quasizero charcoal
...
public:
    ...
    static const ColorRGBA ORCA()        { return {58.0f / 255.0f, 56.0f / 255.0f, 53.0f / 255.0f, 1.0f}; } // Quasizero charcoal
